    ...
    <ContentWrapper>
      <div className="flex flex-wrap justify-between text-sm text-center upper-line">
        <div className="flex justify-center items-center py-6 sm:pt-8 sm:pb-0 w-1/2 sm:w-full">
          ...
          <a className="px-3" href={Config.siteURL.instagram} target="_blank" rel="noreferrer" tabIndex={-1}>
            <button aria-label="Instagramへのリンク">
              <Instagram />
            </button>
          </a>
          <a href={Config.siteURL.github} target="_blank" rel="noreferrer" tabIndex={-1}>
        ...
        <div className="flex flex-col py-6 w-1/2 sm:w-full">
          ...
          <Link href={'/legal'} passHref>
            <button className="p-2" aria-label="特定商取引法に基づく表示を表示する">
              特定商取引法に基づく表示
            </button>
          </Link>
        </div>
