...
type useHandleAddItemType = {
  handleAddItem: (variantIdState: string | null, setLoadingState: (loadingState: boolean) => void) => Promise<void>
}
...
export const useHandleAddItem = (): useHandleAddItemType => {
  ...
  const handleAddItem = useCallback(
    async (variantIdState: string | null, setLoadingState: (loadingState: boolean) => void): Promise<void> => {
