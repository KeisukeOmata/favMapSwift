...
describe('ItemDetail', () => {
  test('should render correctly', async () => {
    ...
    // Description
    const description = screen.getByText('ここにHTML形式でdescriptionが入ります。')
    ...
    // Grey Color Button
    const greyColorButton = screen.getByLabelText('Grey色を選択する') as HTMLButtonElement
    ...
    // L Size Button
    const lSizeButton = screen.getByLabelText('Lサイズを選択する') as HTMLButtonElement
    expect(lSizeButton).toBeInTheDocument()
    expect(lSizeButton.innerHTML).toBe('L')

    // M Size Button
    const mSizeButton = screen.getByLabelText('Mサイズを選択する') as HTMLButtonElement
    expect(mSizeButton).toBeInTheDocument()
    expect(mSizeButton.innerHTML).toBe('M')

    // S Size Button
    const sSizeButton = screen.getByLabelText('Sサイズを選択する') as HTMLButtonElement
