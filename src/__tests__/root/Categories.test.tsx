...
describe('Categories', () => {
  test('should render correctly', async () => {
    ...
    // Category1 Button
    const Category1Button = screen.getByLabelText(
      'NEW ARRIVALを表示する'
    ...
    // Category2 Button
    const Category2Button = screen.getByLabelText(
      'DRESSを表示する'
    ) as HTMLButtonElement
    ...
    // Category3 Button
    const Category3Button = screen.getByLabelText(
      'SKIRT/PANTSを表示する'
    ) as HTMLButtonElement
    ...
    // Category4 Button
    const Category4Button = screen.getByLabelText(
      'SHIRT/BLOUSEを表示する'
    ) as HTMLButtonElement
    ...
    // Category5 Button
    const Category5Button = screen.getByLabelText(
      'CUTSEWを表示する'
    ) as HTMLButtonElement
    ...
    // Category6 Button
    const Category6Button = screen.getByLabelText(
      'JACKET/OUTERWEARを表示する'
    ) as HTMLButtonElement
    expect(Category6Button).toBeInTheDocument()
    expect(Category6Button.innerHTML).toBe('JACKET/OUTERWEAR')

    // Category7 Button
    const Category7Button = screen.getByLabelText(
      'BAG/POUCHを表示する'
    ) as HTMLButtonElement
    ...
    // Category8 Button
    const Category8Button = screen.getByLabelText(
      'ACCESSORYを表示する'
    ) as HTMLButtonElement
    ...
    // Category9 Button
    const Category9Button = screen.getByLabelText(
      'COSMETICを表示する'
    ) as HTMLButtonElement
