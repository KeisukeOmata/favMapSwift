...
export default function Privacy() {
  return (
    <>
      <PageSEO title="privacy" path="/privacy" ogImageUrl={Config.defaultOGImage} />
      <div className="pt-2">
        <ContentWrapper>
          ...
          <div className="pt-5">
            ...
            <p>
              ...
              <br></br>・共同して利用する者の範囲<br></br>Shopify Japan 株式会社とその関連会社（ECツール
              「shopify」運営会社）<br></br>
              <br></br>利用する者の利用目的<br></br>
              ・当方とお客様の間の売買取引のうち、商品の配送など、当方が委託した業務を行うため
              <br></br>・お客様に特別なサービスや新商品等をご案内するため
              <br></br>・お客様に対するアフターサービスを実施するため<br></br> ・購入時の確認及びお知らせの送信のため
              <br></br>
            ...
            <p>Shopify Japan 株式会社とその関連会社（ECツール 「shopify」運営会社）</p>
            <br></br>
            <p>6. クッキーの使用について</p>
            <p>
